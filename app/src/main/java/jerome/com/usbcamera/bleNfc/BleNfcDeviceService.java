package jerome.com.usbcamera.bleNfc;
...
import jerome.com.usbcamera.bleNfc.BleManager.Scanner;
...
public class BleNfcDeviceService extends Service {
    public final static String ACTION_GATT_CONNECTED           = "BleNfcDeviceService.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED        = "BleNfcDeviceService.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_TAG_FIND_TAG             = "BleNfcDeviceService.ACTION_TAG_FIND_TAG";
    public final static String ACTION_TAG_LOSE_TAG             = "BleNfcDeviceService.ACTION_TAG_LOSE_TAG";
